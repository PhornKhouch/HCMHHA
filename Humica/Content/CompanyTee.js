...
(OrgChart._defaultConfig = function (t) {
    ...
    (OrgChart.templates.base = {
        ...
        img_0:
            //'<img src="https://whc.unesco.org/uploads/thumbs/site_0668_0067-750-750-20151104115852.jpg" width="50px" height="50px">',
    ...
    (OrgChart.templates.ana = {
        ...
        <image preserveAspectRatio="xMidYMid slice" clip-path="url(#{randId})" xlink:href="{val}" x="10" y="-10"  width="80" height="80"></image>`,
        link_field_0:
            '<text text-anchor="middle" fill="#aeaeae" ' +
            OrgChart.attr.width +
            '="290" x="0" y="0" style="font-size:10px;">{val}</text>',
    ...
    (OrgChart.templates.ula.field_0 =
        "<text " +
        OrgChart.attr.width +
        '="145" style="font-size: 16px;" fill="#039BE5" x="30" y="35">{val}</text>'),
    (OrgChart.templates.ula.field_1 =
        "<text " +
        OrgChart.attr.width +
        '="145" ' +
        OrgChart.attr.text_overflow +
        '="multiline" style="font-size: 13px;" fill="#afafaf" x="30" y="55">{val}</text>'),
    (OrgChart.templates.ula.node =
        '<rect x="0" y="0" height="{h}" width="{w}" fill="#ffffff" stroke-width="1" stroke="#aeaeae"></rect><line x1="0" y1="0" x2="200" y2="0" stroke-width="2" stroke="#039BE5"></line>'),
            ...
            : {
                html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${a.disabledAttribute
                        ...
                        for (var t = "", e = 0; e < a.options.length; e++) {
                            var r = a.options[e];
                            t += `<option ${r.value == a.value ? "selected" : ""
        ...
        return a.doNotRender
            ...
            : {
                html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${a.disabledAttribute
                        ...
                        a.binding
                    )}" ${a.readOnlyAttribute} maxlength="256" id="${a.id}" name="${a.id
