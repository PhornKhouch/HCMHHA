...
{
    public class RPTRecruitSummaryController : Humica.EF.Controllers.MasterSaleController
    {
        private const string SCREEN_ID = "RPTRCM0003";
        private const string URL_SCREEN = "/Reporting/RPTRecruitSummary/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";

        HumicaDBContext DB = new HumicaDBContext();

        public RPTRecruitSummaryController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RPTSummaryRecruitment sa = new RPTSummaryRecruitment();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RPTSummaryRecruitment reportModel = (RPTSummaryRecruitment)Session[Index_Sess_Obj];
        ...
        {
            SYDataList obj = new SYDataList("STAFF_TYPE");
            ViewData["STAFFTYPE_SELECT"] = obj.ListData;
