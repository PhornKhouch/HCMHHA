...
{
    public class RPTRecruitRequestController : Humica.EF.Controllers.MasterSaleController
    {
        private const string SCREEN_ID = "RPTRCM0001";
        private const string URL_SCREEN = "/Reporting/RPTRecruitRequest/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";

        HumicaDBContext DB = new HumicaDBContext();

        public RPTRecruitRequestController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RPTRecruitmentRequest sa = new RPTRecruitmentRequest();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RPTRecruitmentRequest reportModel = (RPTRecruitmentRequest)Session[Index_Sess_Obj];
