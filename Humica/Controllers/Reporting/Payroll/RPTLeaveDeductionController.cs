...
{
    public class RPTLeaveDeductionController : Humica.EF.Controllers.MasterSaleController
    {

        private const string SCREEN_ID = "RPTPR00014";
        private const string URL_SCREEN = "/Reporting/RPTLeaveDeduction/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTLeaveDeductionController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptLeaveDeduction sa = new RptLeaveDeduction();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptLeaveDeduction reportModel = (RptLeaveDeduction)Session[Index_Sess_Obj];
