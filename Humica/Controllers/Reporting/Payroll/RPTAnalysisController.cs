...
{
    public class RPTAnalysisController : Humica.EF.Controllers.MasterSaleController
    {

        private const string SCREEN_ID = "RPTPR00010";
        private const string URL_SCREEN = "/Reporting/RPTAnalysis/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTAnalysisController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptAnalysis sa = new RptAnalysis();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptAnalysis reportModel = (RptAnalysis)Session[Index_Sess_Obj];
        ...
        private void DataList()
        {
            ...
            //ViewData["BRANCHES_SELECT"] = DH.HRBranches.ToList();
            ...
            //ViewData["LEVEL_SELECT"] = DH.HRLevels.ToList();
        }
    }
}
