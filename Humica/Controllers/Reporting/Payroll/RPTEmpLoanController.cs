...
{
    public class RPTEmpLoanController : Humica.EF.Controllers.MasterSaleController
    {

        private const string SCREEN_ID = "RPT0000018";
        private const string URL_SCREEN = "/Reporting/RPTEmpLoan/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTEmpLoanController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptLoanSummary sa = new RptLoanSummary();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptLoanSummary reportModel = (RptLoanSummary)Session[Index_Sess_Obj];
        ...
        private void DataList()
        {
            ...
            string DEDType = "DED";
            ViewData["DEDUCTION_SELECT"] = DB.PR_RewardsType.Where(w => w.ReCode == DEDType).ToList();
        }
    }
}
