...
{
    public class RPTOverTimeReportController : Humica.EF.Controllers.MasterSaleController
    {

        private const string SCREEN_ID = "RPTPR00012";
        private const string URL_SCREEN = "/Reporting/RPTOverTimeReport/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTOverTimeReportController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RPTOvertime sa = new RPTOvertime();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RPTOvertime reportModel = (RPTOvertime)Session[Index_Sess_Obj];
