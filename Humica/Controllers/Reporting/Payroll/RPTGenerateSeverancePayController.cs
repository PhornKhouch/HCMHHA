...
{
    public class RPTGenerateSeverancePayController : Humica.EF.Controllers.MasterSaleController
    {

        private const string SCREEN_ID = "RPTPR00015";
        private const string URL_SCREEN = "/Reporting/RPTGenerateSeverancePay/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();
        SMSystemEntity DBA = new SMSystemEntity();
        public RPTGenerateSeverancePayController()
            : base()
        {
