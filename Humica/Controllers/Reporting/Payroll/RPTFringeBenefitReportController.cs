...
{
    public class RPTFringeBenefitReportController : Humica.EF.Controllers.MasterSaleController
    {

        private const string SCREEN_ID = "RPTPR00009";
        private const string URL_SCREEN = "/Reporting/RPTFringeBenefitReport/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTFringeBenefitReportController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptFringeBenefit sa = new RptFringeBenefit();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptFringeBenefit reportModel = (RptFringeBenefit)Session[Index_Sess_Obj];
