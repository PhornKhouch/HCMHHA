...
{
    public class RPTEmpDepositController : Humica.EF.Controllers.MasterSaleController
    {

        private const string SCREEN_ID = "RPT0000019";
        private const string URL_SCREEN = "/Reporting/RPTEmpDeposit/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTEmpDepositController()
            : base()
        {
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptDeposit reportModel = (RptDeposit)Session[Index_Sess_Obj];
