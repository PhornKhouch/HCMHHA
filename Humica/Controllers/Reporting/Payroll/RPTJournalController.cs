...
{
    public class RPTJournalController : Humica.EF.Controllers.MasterSaleController
    {

        private const string SCREEN_ID = "RPTPR00011";
        private const string URL_SCREEN = "/Reporting/RPTJournal/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTJournalController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RPTJournalReport sa = new RPTJournalReport();
     ...
     .GetProperties(BindingFlags.Instance | BindingFlags.Public)
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            if (Session[Index_Sess_Obj] != null)
            {
                ...
                RPTJournalReport reportModel = (RPTJournalReport)Session[Index_Sess_Obj];
