...
{
    public class RPTAllowanceReportController : Humica.EF.Controllers.MasterSaleController
    {

        private const string SCREEN_ID = "RPTPR00003";
        private const string URL_SCREEN = "/Reporting/RPTAllowanceReport/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();
        public RPTAllowanceReportController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptAllowance sa = new RptAllowance();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptAllowance reportModel = (RptAllowance)Session[Index_Sess_Obj];
