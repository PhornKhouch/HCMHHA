...
{
    public class RPTKPIEmployeeController : Humica.EF.Controllers.MasterSaleController
    {
        private const string SCREEN_ID = "RPTAP00006";
        private const string URL_SCREEN = "/Reporting/RPTKPIEmployee/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        private const string REPORT_PARTIAL = "PrintForm";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTKPIEmployeeController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RPTSumEmployeeKPI sa = new RPTSumEmployeeKPI();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RPTSumEmployeeKPI reportModel = (RPTSumEmployeeKPI)Session[Index_Sess_Obj];
