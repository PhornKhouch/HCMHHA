...
{
    public class RPTLeaveEntitledController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTLM00001";
        private const string URL_SCREEN = "/Reporting/RPTLeaveEntitled/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTLeaveEntitledController()
            : base()
        {
