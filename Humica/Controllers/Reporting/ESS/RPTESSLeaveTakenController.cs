...
{
    public class RPTESSLeaveTakenController : Humica.EF.Controllers.MasterSaleController
    {
        private const string SCREEN_ID = "RPTESS0001";
        private const string URL_SCREEN = "/Reporting/RPTESSLeaveTaken/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        IClsFilter BSM;
        IUnitOfWork unitOfWork;

        public RPTESSLeaveTakenController()
            : base()
        {
