...
{
    public class RPTESSKPITimeSheetController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTESS0004";
        private const string URL_SCREEN = "/Reporting/RPTESSKPITimeSheet/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        IClsFilter BSM;
        IUnitOfWork unitOfWork;
        public RPTESSKPITimeSheetController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RPTTimeSheet sa = new RPTTimeSheet();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RPTTimeSheet reportModel = (RPTTimeSheet)Session[Index_Sess_Obj];
