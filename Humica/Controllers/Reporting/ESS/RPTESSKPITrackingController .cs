...
{
    public class RPTESSKPITrackingController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTESS0005";
        private const string URL_SCREEN = "/Reporting/RPTESSKPITracking/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        IClsFilter BSM;
        IUnitOfWork unitOfWork;
        public RPTESSKPITrackingController()
            : base()
        {
