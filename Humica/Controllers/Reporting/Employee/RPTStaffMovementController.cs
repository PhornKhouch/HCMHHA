...
{
    public class RPTStaffMovementController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTHR00017";
        private const string URL_SCREEN = "/Reporting/RPTStaffMovement/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();
        public RPTStaffMovementController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptStaffMovement sa = new RptStaffMovement();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptStaffMovement reportModel = (RptStaffMovement)Session[Index_Sess_Obj];
