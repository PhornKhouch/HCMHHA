...
{
    public class RPTEmployeeContactController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTHR00011";
        private const string URL_SCREEN = "/Reporting/RPTEmployeeContact/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();
        public RPTEmployeeContactController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptEmployeeContact sa = new RptEmployeeContact();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptEmployeeContact reportModel = (RptEmployeeContact)Session[Index_Sess_Obj];
