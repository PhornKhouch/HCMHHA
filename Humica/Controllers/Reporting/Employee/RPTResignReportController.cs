...
{
    public class RPTResignReportController : Humica.EF.Controllers.MasterSaleController
    {

        private const string SCREEN_ID = "RPTHR00004";
        private const string URL_SCREEN = "/Reporting/RPTResignReport/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTResignReportController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptResignListing sa = new RptResignListing();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptResignListing reportModel = (RptResignListing)Session[Index_Sess_Obj];
