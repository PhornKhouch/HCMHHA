...
{
    public class RPTDeclareOutController : Humica.EF.Controllers.MasterSaleController
    {
        private const string SCREEN_ID = "RPTHR00003";
        private const string URL_SCREEN = "/Reporting/RPTDeclareOut/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTDeclareOutController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptDeclareOut sa = new RptDeclareOut();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptDeclareOut reportModel = (RptDeclareOut)Session[Index_Sess_Obj];
