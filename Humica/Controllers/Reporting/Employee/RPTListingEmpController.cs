...
{
    public class RPTListingEmpController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTHR00005";
        private const string URL_SCREEN = "/Reporting/RPTListingEmp/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTListingEmpController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptListingEmployee sa = new RptListingEmployee();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptListingEmployee reportModel = (RptListingEmployee)Session[Index_Sess_Obj];
