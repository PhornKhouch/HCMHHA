...
{
    public class RPTFamilyController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTHR00009";
        private const string URL_SCREEN = "/Reporting/RPTFamily/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTFamilyController()
            : base()
        {
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptFamily reportModel = (RptFamily)Session[Index_Sess_Obj];
