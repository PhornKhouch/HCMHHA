...
{
    public class RPTEmpInsuranceController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTHR00011";
        private const string URL_SCREEN = "/Reporting/RPTEmpInsurance/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTEmpInsuranceController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptEmpInsurance sa = new RptEmpInsurance();
                   ...
                   && w.IsActive == true).ToList();
                    ...
                    var Dict = RPT.GetType().GetProperties(BindingFlags.Instance | BindingFlags.Public)
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptEmpInsurance reportModel = (RptEmpInsurance)Session[Index_Sess_Obj];
        ...
        private void DataList()
        {
            ...
            ViewData["INSURANCE_TYPE"] = DB.HRInsuranceTypes.ToList();
        }
    }
}