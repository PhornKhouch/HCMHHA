...
{
    public class RPTEndProbationController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTHR00008";
        private const string URL_SCREEN = "/Reporting/RPTEndProbation/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTEndProbationController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptProbation sa = new RptProbation();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptProbation reportModel = (RptProbation)Session[Index_Sess_Obj];
