...
{
    public class RPTEducationController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTHR00010";
        private const string URL_SCREEN = "/Reporting/RPTEducation/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();
        public RPTEducationController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptEducation sa = new RptEducation();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptEducation reportModel = (RptEducation)Session[Index_Sess_Obj];
