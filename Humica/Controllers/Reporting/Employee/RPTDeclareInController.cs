...
{
    public class RPTDeclareInController : Humica.EF.Controllers.MasterSaleController
    {
        private const string SCREEN_ID = "RPTHR00002";
        private const string URL_SCREEN = "/Reporting/RPTDeclareIn/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTDeclareInController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptDeclareIn sa = new RptDeclareIn();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptDeclareIn reportModel = (RptDeclareIn)Session[Index_Sess_Obj];
