...
{
    public class RPTStaffTShirtController : Humica.EF.Controllers.MasterSaleController
    {
        private const string SCREEN_ID = "RPTHR00016";
        private const string URL_SCREEN = "/Reporting/RPTStaffTShirt/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTStaffTShirtController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RptEmpTShirt sa = new RptEmpTShirt();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptEmpTShirt reportModel = (RptEmpTShirt)Session[Index_Sess_Obj];
