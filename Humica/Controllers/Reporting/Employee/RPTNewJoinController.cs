...
{
    public class RPTNewJoinController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTHR00007";
        private const string URL_SCREEN = "/Reporting/RPTNewJoin/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTNewJoinController()
            : base()
        {
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RptNewJoin reportModel = (RptNewJoin)Session[Index_Sess_Obj];
