...
{
    public class RPTEmpAttendanceController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTAT00001";
        private const string URL_SCREEN = "/Reporting/RPTEmpAttendance/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();
        public RPTEmpAttendanceController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RPTEmpAttendanceDept sa = new RPTEmpAttendanceDept();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RPTEmpAttendanceDept reportModel = (RPTEmpAttendanceDept)Session[Index_Sess_Obj];
