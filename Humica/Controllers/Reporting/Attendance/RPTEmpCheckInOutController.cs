...
{
    public class RPTEmpCheckInOutController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTAT00007";
        private const string URL_SCREEN = "/Reporting/RPTEmpCheckInOut/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();
        public RPTEmpCheckInOutController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
					...
					RPTEmpAttendanceSeparate sa = new RPTEmpAttendanceSeparate();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
				RPTEmpAttendanceSeparate reportModel = (RPTEmpAttendanceSeparate)Session[Index_Sess_Obj];
        ...
        private void DataList()
        {
			...
			ViewData["CheckInOut_SELECT"] = DB.SYDatas.Where(s=>s.DropDownType == "CheckInOutSeparate_SELECT").ToList();
		}
    }
}