...
{
    public class RPTAttendanceSummaryReportController : Humica.EF.Controllers.MasterSaleController

    {
        private const string SCREEN_ID = "RPTAT00002";
        private const string URL_SCREEN = "/Reporting/RPTAttendanceSummaryReport/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName = "";
        HumicaDBContext DB = new HumicaDBContext();

        public RPTAttendanceSummaryReportController()
            : base()
        {
        ...
        public ActionResult DocumentViewerPartial()
        {
            ...
            try
            {
                if (Session[Index_Sess_Obj + ActionName] != null)
                {
                    ...
                    RPTSummaryAttendance sa = new RPTSummaryAttendance();
        ...
        public ActionResult DocumentViewerExportTo()
        {
            ...
            {
                RPTSummaryAttendance reportModel = (RPTSummaryAttendance)Session[Index_Sess_Obj];
