...
{
    public class ESSEmployeeKPIByTeamController : Humica.EF.Controllers.MasterSaleController
    {

        private const string SCREEN_ID = "ESSA000007";
        private const string URL_SCREEN = "/SelfService/Performance/ESSEmployeeKPIByTeam/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName;
        private string KeyName = "AssignCode";
        protected IClsKPIAssign BSM;
        private IUnitOfWork unitOfWork;
        public ESSEmployeeKPIByTeamController()
            : base()
        {
        ...
        public ActionResult Index()
        {
            ...
            BSM.OnIndexLoading(SYDocumentASSIGN.BYTEAM.ToString(), true);
        ...
        public ActionResult Create(string id)
        {
            ...
            UserConfListAndForm(this.KeyName);
            DataSelector();
            if (Session[Index_Sess_Obj + "Index"] != null)
            {
                var obj = (IClsKPIAssign)Session[Index_Sess_Obj + "Index"];
                id = obj.EmpID;
            }
