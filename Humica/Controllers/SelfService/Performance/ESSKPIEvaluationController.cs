...
{
    public class ESSKPIEvaluationController : Humica.EF.Controllers.MasterSaleController
    {
        private const string SCREEN_ID = "ESSA000009";
        private const string URL_SCREEN = "/SelfService/Performance/ESSKPIEvaluation/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName;
        private string KeyName = "KPIEvaCode";
        IClsKPIEvaluation BSM;
        IUnitOfWork unitOfWork;
        public ESSKPIEvaluationController()
            : base()
        {
        ...
        public ActionResult Create(string id,ClsKPIEvaluation collection)
        {
            ...
            string msg =  BSM.Create("HRA0000019");
