...
{
    public class HRKPIPlanIndivController : Humica.EF.Controllers.MasterSaleController
    {
        private const string SCREEN_ID = "HRA0000018";
        private const string URL_SCREEN = "/HRM/Appraisal/HRKPIPlanIndiv/";
        private string Index_Sess_Obj = SYSConstant.BUSINESS_OBJECT_MODEL + SCREEN_ID;
        private string ActionName;
        private string KeyName = "Code;Status";
        HumicaDBContext DB = new HumicaDBContext();
        HumicaDBViewContext DBV = new HumicaDBViewContext();
        public HRKPIPlanIndivController()
            : base()
        {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            var ListHeader = await BSM.LoadData();
            BSM.ListPlanPending = await BSM.LoadDataPlanInPending();
